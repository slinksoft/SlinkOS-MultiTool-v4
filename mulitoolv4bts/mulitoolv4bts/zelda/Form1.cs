...
namespace slinkosmtv4.zelda
{
    public partial class game : Form
    {
        ...
        int knightSystem;
        bool swingdelay;
        System.Media.SoundPlayer swing = new System.Media.SoundPlayer(slinkosmtv4.zelda.Properties.Resources.slashsfx); 
        System.Media.SoundPlayer hit = new System.Media.SoundPlayer(slinkosmtv4.zelda.Properties.Resources.hit); 
       System.Media.SoundPlayer kill = new System.Media.SoundPlayer(slinkosmtv4.zelda.Properties.Resources.kill); 
       System.Media.SoundPlayer deflect = new System.Media.SoundPlayer(slinkosmtv4.zelda.Properties.Resources.deflect); 
       System.Media.SoundPlayer boomerangthrow = new System.Media.SoundPlayer(slinkosmtv4.zelda.Properties.Resources.boomerangthrow); 
        System.Media.SoundPlayer bombdrop = new System.Media.SoundPlayer(slinkosmtv4.zelda.Properties.Resources.bombdrop); 
       System.Media.SoundPlayer bombblow = new System.Media.SoundPlayer(slinkosmtv4.zelda.Properties.Resources.bombblow); 
       System.Media.SoundPlayer getitem = new System.Media.SoundPlayer(slinkosmtv4.zelda.Properties.Resources.getitem); 
       System.Media.SoundPlayer getrupee = new System.Media.SoundPlayer(slinkosmtv4.zelda.Properties.Resources.getrupee); 
       System.Media.SoundPlayer beamsfx = new System.Media.SoundPlayer(slinkosmtv4.zelda.Properties.Resources.beamsfx); 
       System.Media.SoundPlayer hurt = new System.Media.SoundPlayer(slinkosmtv4.zelda.Properties.Resources.hurt); 
       System.Media.SoundPlayer lowhealth = new System.Media.SoundPlayer(slinkosmtv4.zelda.Properties.Resources.lowhealth); 
       System.Media.SoundPlayer die = new System.Media.SoundPlayer(slinkosmtv4.zelda.Properties.Resources.die); 
       System.Media.SoundPlayer secret = new System.Media.SoundPlayer(slinkosmtv4.zelda.Properties.Resources.secret); 
       System.Media.SoundPlayer getheart = new System.Media.SoundPlayer(slinkosmtv4.zelda.Properties.Resources.heart1); 
       System.Media.SoundPlayer gettriforcee = new System.Media.SoundPlayer(slinkosmtv4.zelda.Properties.Resources.gettriforce);
       System.Media.SoundPlayer bossscream = new System.Media.SoundPlayer(slinkosmtv4.zelda.Properties.Resources.bossscream);
       System.Media.SoundPlayer titlebgm = new System.Media.SoundPlayer(slinkosmtv4.zelda.Properties.Resources.titlebgm);
        ...
        private void label1_Click(object sender, EventArgs e)
        {
            ...
            overworldbgm.URL = Convert.ToString("sfx/overworld.wav");
            ...
            this.BackgroundImage = global::slinkosmtv4.zelda.Properties.Resources.a1;
        ...
        private void warpTimer_Tick(object sender, EventArgs e)
        {
         ...
         if (upidle.Bounds.IntersectsWith(warpD3.Bounds))
         {
            ...
            if (upidle.Bounds.IntersectsWith(sword.Bounds))
            {
                ...
                System.Media.SoundPlayer getswordsfx = new System.Media.SoundPlayer(slinkosmtv4.zelda.Properties.Resources.swordsfx);
                getswordsfx.Play();
            }
        ...
        private void roomLoader_Tick(object sender, EventArgs e)
        {
            ...
            if (roomid == 7 && warped == true)
            {
                ...
                this.BackgroundImage = global::slinkosmtv4.zelda.Properties.Resources.shop;
                this.BackgroundImageLayout = System.Windows.Forms.ImageLayout.Stretch;
            ...
            this.BackgroundImage = global::slinkosmtv4.zelda.Properties.Resources.d3;
            this.BackgroundImageLayout = System.Windows.Forms.ImageLayout.Stretch;
            ...
            if (roomid == 5 && warped == true)
            {
                ...
                this.BackgroundImage = global::slinkosmtv4.zelda.Properties.Resources.d2;
                this.BackgroundImageLayout = System.Windows.Forms.ImageLayout.Stretch;
                this.BackColor = System.Drawing.Color.LightSeaGreen;
                warped = false;
                ...
                this.knightl.Image = global::slinkosmtv4.zelda.Properties.Resources.knightl;
                ...
                this.knightr.Image = global::slinkosmtv4.zelda.Properties.Resources.knightr;
            ...
            if (roomid == 4 && warped == true)
            {
                ...
                if (incave == 1 == false)
                {
                    overworldbgm.URL = Convert.ToString("sfx/dungeon.wav");
                    overworldbgm.Ctlcontrols.play();
                    overworldbgm.settings.setMode("loop", true);
                }
 ...
 // 
            ...
            this.swingup.Visible = false;
                ...
                this.or1u.Image = global::slinkosmtv4.zelda.Properties.Resources.orup;
                ...
                this.BackgroundImage = global::slinkosmtv4.zelda.Properties.Resources.a3;
                this.BackgroundImageLayout = System.Windows.Forms.ImageLayout.Stretch;
                this.BackColor = System.Drawing.Color.Khaki;
                warped = false;
            ...
            if (roomid == 2 && warped == true)
            {
                ...
                this.BackgroundImage = global::slinkosmtv4.zelda.Properties.Resources.a2;
                this.BackgroundImageLayout = System.Windows.Forms.ImageLayout.Stretch;
                this.BackColor = System.Drawing.Color.Black;
        ...
        private void linksHealth_Tick(object sender, EventArgs e)
        {
            ...
            {
                linksHealth.Stop();
                MessageBox.Show("Not sure where this path leads anymore... \nKeep your head up, kiddo! You're going places.", "null");
                this.Close();
            ...
            {
                linksHealth.Stop();
                MessageBox.Show("Hmm.. why did this path in the standalone game mention a new soulmate? What is love anyway?\n" +
                    "You should never fear being alone. You have infinite versions of \"you\" in every single timeline and reality" +
                    " in this universe. Being alone sucks sometimes, but it isn't such a bad thing all the time! Why? Because you are" +
                    " not alone. You are never alone. Keep your head up, kiddo! You're going places.", "null");
                this.Close();
                foreach (Form f in Application.OpenForms)
                {
                    if (f is credits)
        ...
        {
            govertimer.Stop();
            MessageBox.Show("Hmm... this seems familiar, huh?", "null");
            this.Close();
            foreach (Form f in Application.OpenForms)
            {
                if (f is credits)
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            //slink os port fix for extraction of audio files after easter egg is discovered
            if (Directory.Exists("sfx/") == false)
            {
                Directory.CreateDirectory("sfx");
                UnmanagedMemoryStream overworldSfx = Properties.Resources.overworld;
                byte[] owB = ReadToEnd(overworldSfx);
                File.WriteAllBytes("sfx/overworld.wav", owB);
                UnmanagedMemoryStream dungeonSfx = Properties.Resources.dungeon;
                byte[] owD = ReadToEnd(dungeonSfx);
                File.WriteAllBytes("sfx/dungeon.wav", owD);
                UnmanagedMemoryStream lowhealthSfx = Properties.Resources.lowhealth;
                byte[] lowh = ReadToEnd(lowhealthSfx);
                File.WriteAllBytes("sfx/lowhealth.wav", lowh);
            }
        
        }

        /*conversion of embedded wav files to byte array for extraction ; slinkos port fix
         This is code is needed to keep the Zelda demo from being exposed, thus ruining the easter egg
         vibe it gets. Credits: https://stackoverflow.com/questions/1080442/how-to-convert-an-stream-into-a-byte-in-c/1080445#1080445*/
